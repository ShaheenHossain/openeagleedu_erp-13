...
- Added new backend theme for OpenEagleEdu. `Enterprise`
...
`8.0.0`
-------
- OpenEagleEdu Now compatible with Eagle v8.
- Added demo portal
...
- Added Annoucement Bar on the top to keep users updated with latest news about OpenEagleEdu
- minor bug fixes
