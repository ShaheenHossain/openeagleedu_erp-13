...

{
    ...
    'qweb': [
        ...
        'static/src/xml/dashboard_ext_openeagleedu.xml'
    ],
    'js': [],
    'images': [
        'static/description/openeagleedu_core_banner.jpg',
    ],
    'installable': True,
    'auto_install': False,
    'application': True,
